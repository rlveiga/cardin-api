...
def test_get_collection_info(test_client, init_db, token):
  ...
  assert data['collection']['cards'][0]['name'] == 'Deletable card'
...
def test_get_unauthorized_collection_info(test_client, init_db, token):
  response = test_client.get('/collections/2', headers={'access-token': token})
...
def test_delete_collection(test_client, init_db, token):
  response = test_client.delete(
      '/collections/5', headers={'access-token': token})
...
def test_delete_unauthorized_collection(test_client, init_db, token):
  response = test_client.delete(
      '/collections/4', headers={'access-token': token})
...
def test_get_cards_from_collection(test_client, init_db, token):
  response = test_client.get(
      '/collections/3/cards', headers={'access-token': token})
...
def test_get_cards_from_unexisting_collection(test_client, init_db, token):
  response = test_client.get(
      '/collections/42/cards', headers={'access-token': token})
...
def test_get_cards_from_unauthorized_collection(test_client, init_db, token):
  response = test_client.get(
      '/collections/4/cards', headers={'access-token': token})
